import { c as createLucideIcon, g as useAppState, o as useProfile, h as useCurrentDay, i as useCurrentDayProgress, k as useAllProgress, l as useStreak, t as calcDayCompletion, v as calcOverallCompletion, r as reactExports, j as jsxRuntimeExports, S as Skeleton, B as Button, w as ue } from "./index-B7gz-m_n.js";
...
function Sparkline({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-[3px] h-10", children: allProgress.map((day) => {
    ...
    const opacity2 = isFuture ? 0.15 : pct >= 1 ? 1 : pct > 0 ? 0.55 : 0.2;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          ...
          backgroundColor: `rgba(255, 255, 255, ${opacity2})`
        }
      },
      `spark-${day.day}`
    );
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse at 60% 0%, rgba(255,255,255,0.04) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex items-center justify-between px-7 pt-7 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: "30 Days Challenge"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 px-7 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 px-7 pt-5 pb-2 flex items-end gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", style: { lineHeight: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 px-7 flex gap-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 px-7 mt-8 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkline, { allProgress, currentDay })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 px-7 py-6 mt-auto flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
...
async function captureCardAsBlob(el) {
  ...
  await new Promise(
    (resolve) => requestAnimationFrame(() => setTimeout(resolve, 100))
  );
...
function SharePage() {
  ...
  const shareCardRef = reactExports.useRef(null);
  ...
  async function handleDownload() {
    ...
    try {
      ...
      ue.success("Gambar berhasil diunduh!");
    } catch (err) {
      console.error("Download failed:", err);
      ue.error("Gagal mengunduh gambar. Coba screenshot manual ya!");
    } finally {
      setCapturing(false);
    }
  }
  async function handleInstagramShare() {
    ...
    try {
      ...
      if (!isAbort) {
        ue.error("Gagal share ke Instagram. Coba download dulu.");
      }
    } finally {
      setCapturing(false);
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg mx-auto px-4 py-8 pb-28 md:pb-10 space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "space-y-1",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground tracking-tight", children: "Bagikan Progress" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Kartu progres personal kamu — download atau bagikan ke Instagram!" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-[360px] h-[560px] rounded-3xl" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: shareCardRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ShareCardVisual,
          {
            username,
            streak,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.p,
      {
        ...
        children: "Share langsung dari perangkat mobile. Di desktop, download dulu lalu upload ke Instagram."
      }
    )
  ] });
}
