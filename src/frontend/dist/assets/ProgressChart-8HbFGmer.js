import { C as commonjsGlobal, E as getDefaultExportFromCjs, r as reactExports, F as clsx, G as React, H as invariant, t as calcDayCompletion, j as jsxRuntimeExports } from "./index-B7gz-m_n.js";
...
function CustomTooltip({ active, payload }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl px-3 py-2 shadow-elevated text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-medium text-foreground", children: [
      "Day ",
      data.payload.day
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-0.5", children: data.payload.status === "future" ? "Not started yet" : `${data.value}% completed` })
  ] });
}
function ProgressChart({ allProgress, currentDay }) {
  const chartData = allProgress.map((d2) => {
    const status = d2.day < currentDay ? "past" : d2.day === currentDay ? "current" : "future";
    const completion = status === "future" ? 0 : calcDayCompletion(d2);
    return {
      day: d2.day,
      completion,
      status,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 180, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    BarChart,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomTooltip, {}), cursor: { fill: "transparent" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "completion", radius: [4, 4, 0, 0], children: chartData.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Cell,
          {
            fill: entry.status === "future" ? "oklch(var(--muted))" : entry.status === "current" ? "oklch(var(--accent))" : entry.completion === 100 ? "oklch(var(--accent))" : "oklch(var(--accent) / 0.45)"
          },
          `cell-${entry.day}`
        )) })
      ]
